                    ...
                    <table class="table">
                      <thead>
                        <tr>
                          ...
                          <th scope="col">Endereço da aula</th>
                        </tr>
                      </thead>
                      <tbody>
                        @foreach($registrosAula as $registrosAulas)
                        <tr>
                          <th scope="row">{{$registrosAulas->id}}</th>
                          <td>{{$registrosAulas->idcurso}}</td>
                          <td>{{$registrosAulas->tituloaula}}</td>
                          <td>{{$registrosAulas->urlaula}}</td>
                          <td>
                            <a href="{{route('alterar-aula', $registrosAulas->id)}}">
                          ...
                          <td>
                            <form method="Post" Action="{{route('deletarAula', $registrosAulas->id)}}">
                              @method('delete')
                              @csrf
